...
Helps you with: [split settings](https://docs.djangoproject.com/en/stable/topics/settings/), [DATABASE_URL](https://docs.djangoproject.com/en/stable/ref/settings/#databases), [custom user model](https://docs.djangoproject.com/en/stable/topics/auth/customizing/#substituting-a-custom-user-model), [security headers](https://docs.djangoproject.com/en/stable/topics/security/), [Python deps & venvs](https://docs.astral.sh/uv/), [env-driven settings](https://django-environ.readthedocs.io/), [password + social login](https://docs.allauth.org/), [passwordless magic-link login](https://django-mail-auth.readthedocs.io/), [brute-force lockout](https://django-axes.readthedocs.io/), [distributed task queue](https://docs.celeryq.dev/), [Redis cache](https://github.com/jazzband/django-redis), [S3 storage backend](https://django-storages.readthedocs.io/), [transactional email](https://anymail.dev/), [Tailwind without Node](https://django-tailwind-cli.readthedocs.io/), [privacy-first analytics](https://www.goatcounter.com/help/start), [Content Security Policy](https://django-csp.readthedocs.io/), [error tracking](https://docs.sentry.io/platforms/python/integrations/django/), [N+1 query detection](https://github.com/PedroBern/django-zeal), [linter & formatter](https://docs.astral.sh/ruff/), [type checker](https://microsoft.github.io/pyright/), [structured logging](https://www.structlog.org/), [database backups](https://django-dbbackup.readthedocs.io/), [Docker images & compose](https://docs.docker.com/compose/), [reverse proxy with auto-HTTPS](https://caddyserver.com/docs/), [GitHub Actions CI](https://docs.github.com/en/actions) — and more.
